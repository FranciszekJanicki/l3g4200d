...
static l3g4200d_err_t l3g4200d_bus_deinitialize(l3g4200d_t const* l3g4200d)
{
    return l3g4200d->interface.bus_deinitialize
               ? l3g4200d->interface.bus_deinitialize(l3g4200d->interface.bus_user)
               : L3G4200D_ERR_NULL;
}
...
l3g4200d_err_t l3g4200d_get_who_am_i_reg(l3g4200d_t const* l3g4200d, l3g4200d_who_am_i_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_WHO_AM_I, &data, sizeof(data));
...
l3g4200d_err_t l3g4200d_get_ctrl1_reg(l3g4200d_t const* l3g4200d, l3g4200d_ctrl1_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_CTRL1, &data, sizeof(data));
...
l3g4200d_err_t l3g4200d_set_ctrl1_reg(l3g4200d_t const* l3g4200d, l3g4200d_ctrl1_reg_t const* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_write_data(l3g4200d, L3G4200D_REG_ADDR_CTRL1, &data, sizeof(data));
...
l3g4200d_err_t l3g4200d_get_ctrl2_reg(l3g4200d_t const* l3g4200d, l3g4200d_ctrl2_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_CTRL2, &data, sizeof(data));
...
l3g4200d_err_t l3g4200d_set_ctrl2_reg(l3g4200d_t const* l3g4200d, l3g4200d_ctrl2_reg_t const* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_write_data(l3g4200d, L3G4200D_REG_ADDR_CTRL2, &data, sizeof(data));
...
l3g4200d_err_t l3g4200d_get_ctrl3_reg(l3g4200d_t const* l3g4200d, l3g4200d_ctrl3_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_CTRL3, &data, sizeof(data));
...
l3g4200d_err_t l3g4200d_get_ctrl4_reg(l3g4200d_t const* l3g4200d, l3g4200d_ctrl4_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_CTRL4, &data, sizeof(data));
...
l3g4200d_err_t l3g4200d_set_ctrl4_reg(l3g4200d_t const* l3g4200d, l3g4200d_ctrl4_reg_t const* reg)
{
    ...
    err |= l3g4200d_bus_write_data(l3g4200d, L3G4200D_REG_ADDR_CTRL4, &data, sizeof(data));
...
l3g4200d_err_t l3g4200d_get_ctrl5_reg(l3g4200d_t const* l3g4200d, l3g4200d_ctrl5_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_CTRL5, &data, sizeof(data));
...
l3g4200d_err_t l3g4200d_set_ctrl5_reg(l3g4200d_t const* l3g4200d, l3g4200d_ctrl5_reg_t const* reg)
{
    ...
    err |= l3g4200d_bus_write_data(l3g4200d, L3G4200D_REG_ADDR_CTRL5, &data, sizeof(data));
...
l3g4200d_err_t l3g4200d_get_status_reg(l3g4200d_t const* l3g4200d, l3g4200d_status_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_STATUS, &data, sizeof(data));
...
l3g4200d_err_t l3g4200d_get_out_x_reg(l3g4200d_t const* l3g4200d, l3g4200d_out_x_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_OUT_X_L, data, sizeof(data));
...
l3g4200d_err_t l3g4200d_get_out_y_reg(l3g4200d_t const* l3g4200d, l3g4200d_out_y_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_OUT_Y_L, data, sizeof(data));
...
l3g4200d_err_t l3g4200d_get_out_z_reg(l3g4200d_t const* l3g4200d, l3g4200d_out_z_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_OUT_Z_L, data, sizeof(data));
...
l3g4200d_err_t l3g4200d_get_fifo_ctrl_reg(l3g4200d_t const* l3g4200d, l3g4200d_fifo_ctrl_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_FIFO_CTRL, &data, sizeof(data));
                                          ...
                                          l3g4200d_fifo_ctrl_reg_t const* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_write_data(l3g4200d, L3G4200D_REG_ADDR_FIFO_CTRL, &data, sizeof(data));
...
l3g4200d_err_t l3g4200d_get_fifo_src_reg(l3g4200d_t const* l3g4200d, l3g4200d_fifo_src_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_FIFO_SRC, &data, sizeof(data));
                                         ...
                                         l3g4200d_fifo_src_reg_t const* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_write_data(l3g4200d, L3G4200D_REG_ADDR_FIFO_SRC, &data, sizeof(data));
...
l3g4200d_err_t l3g4200d_get_int1_cfg_reg(l3g4200d_t const* l3g4200d, l3g4200d_int1_cfg_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_INT1_CFG, &data, sizeof(data));
                                         ...
                                         l3g4200d_int1_cfg_reg_t const* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_write_data(l3g4200d, L3G4200D_REG_ADDR_INT1_CFG, &data, sizeof(data));
...
l3g4200d_err_t l3g4200d_get_int1_src_reg(l3g4200d_t const* l3g4200d, l3g4200d_int1_src_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_INT1_SRC, &data, sizeof(data));
                                         ...
                                         l3g4200d_int1_src_reg_t const* reg)
{
    ...
    err |= l3g4200d_bus_write_data(l3g4200d, L3G4200D_REG_ADDR_INT1_SRC, &data, sizeof(data));
                                           ...
                                           l3g4200d_int1_ths_x_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_INT1_THS_XH, data, sizeof(data));
                                           ...
                                           l3g4200d_int1_ths_x_reg_t const* reg)
{
    ...
    err |= l3g4200d_bus_write_data(l3g4200d, L3G4200D_REG_ADDR_INT1_THS_XH, data, sizeof(data));
                                           ...
                                           l3g4200d_int1_ths_y_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_INT1_THS_YH, data, sizeof(data));
                                           ...
                                           l3g4200d_int1_ths_y_reg_t const* reg)
{
    ...
    err |= l3g4200d_bus_write_data(l3g4200d, L3G4200D_REG_ADDR_INT1_THS_YH, data, sizeof(data));
                                           ...
                                           l3g4200d_int1_ths_z_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_INT1_THS_ZH, data, sizeof(data));
                                           ...
                                           l3g4200d_int1_ths_z_reg_t const* reg)
{
    ...
    err |= l3g4200d_bus_write_data(l3g4200d, L3G4200D_REG_ADDR_INT1_THS_ZH, data, sizeof(data));
                                              ...
                                              l3g4200d_int1_duration_reg_t* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_read_data(l3g4200d, L3G4200D_REG_ADDR_INT1_DURATION, &data, sizeof(data));
                                              ...
                                              l3g4200d_int1_duration_reg_t const* reg)
{
    ...
    l3g4200d_err_t err =
        l3g4200d_bus_write_data(l3g4200d, L3G4200D_REG_ADDR_INT1_DURATION, &data, sizeof(data));
