...
typedef struct {
    void* bus_user;
    l3g4200d_err_t (*bus_initialize)(void*);
    l3g4200d_err_t (*bus_deinitialize)(void*);
    l3g4200d_err_t (*bus_write_data)(void*, uint8_t, uint8_t const*, size_t);
    l3g4200d_err_t (*bus_read_data)(void*, uint8_t, uint8_t*, size_t);
